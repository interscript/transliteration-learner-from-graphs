...
with open(params['nnets']['VOCAB_TRAFO'], 'rb') as handle:
...
# Transforms dict
token_transform = {}
token_transform[SRC_LAN] = lambda txt: dcder.tokenizer(txt)
token_transform[TGT_LAN] = lambda txt: dcder.tokenizer(txt)
