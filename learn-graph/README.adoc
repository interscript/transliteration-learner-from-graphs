...
----
julia train.jl –-help
julia train.jl --path-lucidchart-csv resources/FullDemo.csv --brain-entry transliterator --path-model resources/Demo.dat
julia train.jl --dir-path-lucidchart-csv resources/modelDir/ --brain-entry preprocessor --path-model resources/Demo.dat
----
...
julia runDBGCode.jl --path-model resources/Demo.dat --text "abcd efgh"
----
